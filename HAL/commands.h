...
#define STATE_SLEEP 0x00      // SLEEP
#define STATE_IDLE 0x01       // IDLE
#define STATE_XOFF 0x02       //  XOFF
#define STATE_VCOON_MC 0x03   // MANCAL
#define STATE_REGON_MC 0x04   // MANCAL
#define STATE_MANCAL 0x05     // MANCAL
#define STATE_VCOON 0x06      // FS_WAKEUP
#define STATE_REGON 0x07      // FS_WAKEUP
#define STATE_STARTCAL 0x08   // CALIBRATE
#define STATE_BWBOOST 0x09    // SETTLING
#define STATE_FS_LOCK 0x0A    // SETTLING
#define STATE_IFADCON 0x0B    // SETTLING
#define STATE_ENDCAL 0x0C     // CALIBRATE
#define STATE_RX 0x0D         // RX
#define STATE_RX_END 0x0E     // RX
#define STATE_RX_RST 0x0F     // RX
#define STATE_TXRX_SWITCH 0x10  // TXRX_SETTLING
#define STATE_RXFIFO_OVERFLOW 0x11  // RXFIFO_OVERFLOW
#define STATE_FSTXON 0x12     // FSTXON
#define STATE_TX 0x13         // TX
#define STATE_TX_END 0x14     //  TX
#define STATE_RXTX_SWITCH 0x15  // RXTX_SETTLING
#define STATE_TXFIFO_UNDERFLOW 0x16 // TXFIFO_UNDERFLOW


#define PKTSTATUS_CRC_OK BIT7 

#endif	// __RADIO_COMMANDS_H
